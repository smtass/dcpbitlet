...
public final class Utils {
    ...
    public static byte[] utf8ToLocalCharset(String t) {
        try {
            //String utf8 = new String(t.getBytes(), "UTF-8");
            return t.getBytes(Charset.defaultCharset().name());
        }
        catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public static byte[] utf8ToLocalCharset(byte[] t) {
        try {
            String utf8 = new String(t, "UTF-8");
            return utf8.getBytes(Charset.defaultCharset().name());
        }
        catch (Exception e){
            e.printStackTrace();
            return null;
